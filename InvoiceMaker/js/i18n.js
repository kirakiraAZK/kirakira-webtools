...
const TRANSLATIONS = {
  en: {
    ...
    step3_important: '<b>IMPORTANT:</b> On the right panel, fill the <b>To Email</b> field with <code>{{email}}</code> so the email reaches the customer.',
    step3_img: '📸 Screenshot: Template editor right panel — fill "To Email" with {{email}}',
    ...
    step4_important: '<b>IMPORTANT:</b> Make sure <b>To Email</b> is also set to <code>{{email}}</code>.',
    step4_img: '📸 Screenshot: Paid confirmation template editor',
  ...
  id: {
    ...
    step3_important: '<b>PENTING:</b> Di panel kanan, isi kolom <b>To Email</b> dengan <code>{{email}}</code> agar email sampai ke pelanggan.',
    step3_img: '📸 Screenshot: Panel kanan editor template — isi "To Email" dengan {{email}}',
    ...
    step4_important: '<b>PENTING:</b> Pastikan <b>To Email</b> juga diisi <code>{{email}}</code>.',
    step4_img: '📸 Screenshot: Editor template konfirmasi pembayaran',
